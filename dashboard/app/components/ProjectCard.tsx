...
export default function ProjectCard({ title, apiKey, lastError, errorCount }: ProjectCardProps) {
  return (
    <div className="group bg-[#2C2C2D] border border-[#3A3A3B] rounded-lg overflow-hidden hover:border-[#4F46E5] hover:shadow-lg hover:shadow-[#4F46E5]/10 transition-all">
      <div className="p-5 flex flex-col h-full">
        <div className="flex items-center justify-between mb-3">
          <h3 className="font-semibold text-[17px] text-white group-hover:text-[#7C70FF] transition-colors line-clamp-1">{title}</h3>
          <div className="flex space-x-1">
            <button className="p-1 text-[#9CA3AF] hover:text-white rounded-md hover:bg-[#3A3A3B] transition-colors">
        ...
        <div className="flex items-center mb-3 bg-[#252526] rounded-md px-2 py-1.5 border border-[#3A3A3B] cursor-pointer hover:border-[#4F46E5]/50 group-hover:border-[#4F46E5]/50 transition-colors">
          <div className="flex items-center flex-1 truncate">
            ...
            <button className="ml-2 text-[#9CA3AF] hover:text-white p-0.5 rounded-md hover:bg-[#3A3A3B] transition-colors flex-shrink-0">
        ...
        <div className="mb-4 bg-[#252526] rounded-md p-2.5 border border-[#3A3A3B] group-hover:border-[#4F46E5]/20 transition-colors flex-grow">
        ...
        <button className="w-full py-2 text-sm font-medium text-white bg-[#4F46E5] rounded-md hover:bg-[#4338CA] transition-colors mt-auto group-hover:shadow-md">
          View Details
        </button>
      </div>
    </div>
