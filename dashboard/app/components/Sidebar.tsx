      ...
      <div className="p-4 flex flex-col h-full">
        <div className="mb-8 pt-2 px-2">
          <div className="flex items-center">
            <svg
              viewBox="0 0 24 24"
              className="h-7 w-7 mr-2 text-[#7263FF]"
              fill="currentColor"
            >
              <path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5"></path>
            </svg>
            <h1 className="font-bold text-xl text-white tracking-tight">
              Crash<span className="text-[#7263FF]">-Log</span>
            </h1>
          </div>
        </div>
        ...
        <nav className="space-y-1 mb-6">
          <SidebarLink href="/" active={pathname === '/' || pathname.startsWith('/projects/')}>
            <svg
          ...
          <SidebarLink href="/analytics" active={pathname === '/analytics'}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-5 w-5 mr-3"
              fill="none"
        ...
        <nav className="space-y-1">
          <SidebarLink href="/documentation" active={pathname === '/documentation'}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-5 w-5 mr-3"
              fill="none"
          ...
          <SidebarLink href="/api-docs" active={pathname === '/api-docs'}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-5 w-5 mr-3"
              fill="none"
        ...
        <div className="mt-auto">
          ...
          <SidebarLink href="/logout" active={pathname === '/logout'}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-5 w-5 mr-3"
              fill="none"
